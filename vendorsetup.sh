...
echo "Cloning ViPER4AndroidFX Tree"
	git clone https://github.com/xiaomi-sm8450-marble/android_packages_apps_ViPER4AndroidFX.git -b 15-qpr2 packages/apps/ViPER4AndroidFX
